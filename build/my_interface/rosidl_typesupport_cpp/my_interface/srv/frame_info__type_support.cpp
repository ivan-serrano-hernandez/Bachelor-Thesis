...
static const _FrameInfo_Request_type_support_symbol_names_t _FrameInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interface, srv, FrameInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interface, srv, FrameInfo_Request)),
  }
};
...
{
  return &::my_interface::srv::rosidl_typesupport_cpp::FrameInfo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_interface, srv, FrameInfo_Request)() {
  return get_message_type_support_handle<my_interface::srv::FrameInfo_Request>();
}
...
static const _FrameInfo_Response_type_support_symbol_names_t _FrameInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interface, srv, FrameInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interface, srv, FrameInfo_Response)),
  }
};
...
{
  return &::my_interface::srv::rosidl_typesupport_cpp::FrameInfo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_interface, srv, FrameInfo_Response)() {
  return get_message_type_support_handle<my_interface::srv::FrameInfo_Response>();
}
...
static const _FrameInfo_type_support_symbol_names_t _FrameInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interface, srv, FrameInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interface, srv, FrameInfo)),
  }
};
...
{
  return &::my_interface::srv::rosidl_typesupport_cpp::FrameInfo_service_type_support_handle;
}
