...
#ifndef MY_INTERFACE__SRV__DETAIL__FRAME_INFO__FUNCTIONS_H_
#define MY_INTERFACE__SRV__DETAIL__FRAME_INFO__FUNCTIONS_H_
...
/// Initialize srv/FrameInfo message.
/**
...
/// Finalize srv/FrameInfo message.
/**
...
/// Create srv/FrameInfo message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_interface__srv__FrameInfo_Request__init().
...
/// Destroy srv/FrameInfo message.
/**
 * It calls
 * my_interface__srv__FrameInfo_Request__fini()
...
/// Check for srv/FrameInfo message equality.
/**
...
/// Initialize array of srv/FrameInfo messages.
/**
...
/// Finalize array of srv/FrameInfo messages.
/**
 * It calls
 * my_interface__srv__FrameInfo_Request__fini()
...
/// Create array of srv/FrameInfo messages.
/**
 * It allocates the memory for the array and calls
 * my_interface__srv__FrameInfo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/FrameInfo messages.
/**
 * It calls
 * my_interface__srv__FrameInfo_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/FrameInfo message array equality.
/**
...
/// Copy an array of srv/FrameInfo messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_interface__srv__FrameInfo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interface
...
/**
 * It calls
 * my_interface__srv__FrameInfo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interface
...
/**
 * It allocates the memory for the array and calls
 * my_interface__srv__FrameInfo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_interface
...
/**
 * It calls
 * my_interface__srv__FrameInfo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_INTERFACE__SRV__DETAIL__FRAME_INFO__FUNCTIONS_H_
