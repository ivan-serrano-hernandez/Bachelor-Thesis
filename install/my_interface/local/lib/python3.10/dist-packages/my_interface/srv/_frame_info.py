...
class Metaclass_FrameInfo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_interface.srv import _frame_info
...
class FrameInfo(metaclass=Metaclass_FrameInfo):
    from my_interface.srv._frame_info import FrameInfo_Request as Request
    from my_interface.srv._frame_info import FrameInfo_Response as Response
