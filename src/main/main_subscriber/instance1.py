    ...
    def listener_callback(self, msg):
        ...
        if ret:
            ...
            for box, score, cl in zip(boxes, scores, classes):
                ...
                self.main_client.req.x_coord.append((x_min + x_max)/2.0)
                self.main_client.req.y_coord.append((y_min + y_max)/2.0)
                self.main_client.req.classes.append(name)
                self.main_client.req.classes_confidence.append(
