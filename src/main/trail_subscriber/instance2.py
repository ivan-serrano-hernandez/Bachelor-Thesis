...
class Receiver(Node):
    ...
    def listener_callback(self, msg):
        ...
        self.trail_client.req.x_coord = [1.0]
        self.trail_client.req.y_coord = [1.0]
        self.trail_client.req.classes = ['bus']
        self.trail_client.req.classes_confidence = [0.9]
        ...
        self.logfile.write(f'{time.time()} : frames {self.frame_counter} just processed\n')
